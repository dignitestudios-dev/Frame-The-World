        ...
        try {
          ...
          if (firstResult) {
            ...
            onPlaceSelect({
              ...
              latitude: lat,
              longitude: lng,
              city: getFirstAddressComponent(firstResult.address_components, [
                "locality",
                "postal_town",
                "administrative_area_level_3",
                "administrative_area_level_2",
              ]),
              state: getFirstAddressComponent(firstResult.address_components, [
            ...
            onPlaceSelect({ address: description });
          }
        } catch {
          onPlaceSelect({ address: description });
        }
