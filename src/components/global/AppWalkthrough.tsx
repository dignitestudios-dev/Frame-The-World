...
const walkthroughContent = [
  {
    image: "/images/silde-images.mp4",
    imageClassName: "object-cover",
    imageContainerClassName: "relative w-full h-full",
  ...
  {
    image: "/images/rank-profile.mp4",
    imageClassName: "object-contain",
    imageContainerClassName: "relative w-[100%] h-full flex items-center justify-center",
        ...
        <div className="flex-1 relative flex items-center justify-center overflow-hidden ">
          ...
          <div key={currentStep} className={`animate-in fade-in zoom-in slide-in-from-bottom-4 duration-700 flex items-center justify-center h-full w-full`}>
            <div className={currentContent.imageContainerClassName}>
              {currentContent.image?.endsWith(".mp4") ? (
                <video
                  src={currentContent.image}
                  autoPlay
                  loop
                  muted
                  className={`${currentContent.imageClassName} rounded-2xl`}
                />
              ) : (
              <Image
                src={currentContent.image || ""}
